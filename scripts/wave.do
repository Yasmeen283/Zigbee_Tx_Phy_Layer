...
add wave -noupdate -expand -group TOP /tb/payload_length_reg
add wave -noupdate -expand -group TOP /tb/chirp_index
add wave -noupdate -expand -group TOP /tb/tx_done
add wave -noupdate -expand -group TOP /tb/tx_real
add wave -noupdate -expand -group TOP /tb/exp_real_dbg
add wave -noupdate -expand -group TOP /tb/tx_imag
add wave -noupdate -expand -group TOP /tb/exp_imag_dbg
add wave -noupdate -expand -group TOP /tb/tx_valid
add wave -noupdate -expand -group TOP /tb/fifo_overflow
add wave -noupdate /tb/cycles_waited
add wave -noupdate /tb/timed_out
add wave -noupdate -expand -group {not needed} /tb/got_real_dbg
add wave -noupdate -expand -group {not needed} /tb/got_imag_dbg
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {162881 ps} 0}
...
update
WaveRestoreZoom {134277 ps} {237518 ps}
